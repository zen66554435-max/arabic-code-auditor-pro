...
```bash
git clone https://github.com/GENERAL/arabic-code-auditor-pro.git && cd arabic-code-auditor-pro && bash install.sh
```
...
> **ملاحظة:** الأداة مفتوحة المصدر للاستخدام، لكن الكود الأساسي محمي من التعديل.

### طبقات الحماية

| الطبقة | الوصف |
|--------|-------|
| 🛡️ **Obfuscation** | تشويش الكود الأساسي |
| ⚡ **Cython** | ترجمة إلى C مترجم |
| 📦 **PyInstaller** | تجميع إلى Executable |
...
| الملف | الوصف |
|-------|-------|
| `obfuscate.py` | سكربت التشويش |
| `setup_cython.py` | بناء Cython |
| `aca.spec` | إعدادات PyInstaller |
| `build.sh` | سكربت البناء الكامل |
